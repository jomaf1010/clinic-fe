...
import { defaultMedCertTemplate } from '@/domains/template/types/template.types'
...
const template = reactive({ ...defaultMedCertTemplate })
...
<template>
  <div class="flex flex-1 flex-col gap-4 pt-4">
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-lg font-semibold">Edit Medical Certificate Template</h1>
        <p class="text-sm text-muted-foreground">Customize the layout for medical certificates</p>
      </div>
      ...
      <div class="flex flex-col gap-4 overflow-y-auto">
          ...
          <CardContent class="flex flex-col gap-4">
            <div class="flex flex-col gap-3">
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-logo" :model-value="template.header.showLogo" @update:model-value="template.header.showLogo = !!$event" />
                <Label for="mc-show-logo" class="font-normal">Show clinic logo</Label>
              </div>
              ...
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-clinic-name" :model-value="template.header.showClinicName" @update:model-value="template.header.showClinicName = !!$event" />
                <Label for="mc-show-clinic-name" class="font-normal">Show clinic name</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-clinic-address" :model-value="template.header.showClinicAddress" @update:model-value="template.header.showClinicAddress = !!$event" />
                <Label for="mc-show-clinic-address" class="font-normal">Show clinic address</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-clinic-contact" :model-value="template.header.showClinicContact" @update:model-value="template.header.showClinicContact = !!$event" />
                <Label for="mc-show-clinic-contact" class="font-normal">Show clinic contact</Label>
              </div>
            </div>
            <div class="flex flex-col gap-2">
        ...
        <Card>
          ...
          <CardContent class="flex flex-col gap-3">
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-patient-name" :model-value="template.body.showPatientName" @update:model-value="template.body.showPatientName = !!$event" />
              <Label for="mc-show-patient-name" class="font-normal">Show patient name</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-patient-age" :model-value="template.body.showPatientAge" @update:model-value="template.body.showPatientAge = !!$event" />
              <Label for="mc-show-patient-age" class="font-normal">Show patient age</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-patient-gender" :model-value="template.body.showPatientGender" @update:model-value="template.body.showPatientGender = !!$event" />
              <Label for="mc-show-patient-gender" class="font-normal">Show patient gender</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-patient-address" :model-value="template.body.showPatientAddress" @update:model-value="template.body.showPatientAddress = !!$event" />
              <Label for="mc-show-patient-address" class="font-normal">Show patient address</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-exam-date" :model-value="template.body.showDateOfExamination" @update:model-value="template.body.showDateOfExamination = !!$event" />
              <Label for="mc-show-exam-date" class="font-normal">Show date of examination</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-diagnosis" :model-value="template.body.showDiagnosis" @update:model-value="template.body.showDiagnosis = !!$event" />
              <Label for="mc-show-diagnosis" class="font-normal">Show diagnosis / findings</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-recommendation" :model-value="template.body.showRecommendation" @update:model-value="template.body.showRecommendation = !!$event" />
              <Label for="mc-show-recommendation" class="font-normal">Show recommendation</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-duration" :model-value="template.body.showDuration" @update:model-value="template.body.showDuration = !!$event" />
              <Label for="mc-show-duration" class="font-normal">Show duration (from - to)</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-purpose" :model-value="template.body.showPurpose" @update:model-value="template.body.showPurpose = !!$event" />
              <Label for="mc-show-purpose" class="font-normal">Show purpose</Label>
            </div>
            <div class="flex items-center gap-2">
              <Checkbox id="mc-show-disclaimer" :model-value="template.body.showDisclaimer" @update:model-value="template.body.showDisclaimer = !!$event" />
              <Label for="mc-show-disclaimer" class="font-normal">Show disclaimer</Label>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent class="flex flex-col gap-4">
            <div class="flex flex-col gap-3">
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-signature" :model-value="template.footer.showDoctorSignature" @update:model-value="template.footer.showDoctorSignature = !!$event" />
                <Label for="mc-show-signature" class="font-normal">Show doctor signature line</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-specialty" :model-value="template.footer.showSpecialty" @update:model-value="template.footer.showSpecialty = !!$event" />
                <Label for="mc-show-specialty" class="font-normal">Show specialty</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-sub-specialty" :model-value="template.footer.showSubSpecialty" @update:model-value="template.footer.showSubSpecialty = !!$event" />
                <Label for="mc-show-sub-specialty" class="font-normal">Show sub-specialty</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-prc" :model-value="template.footer.showPrcLicense" @update:model-value="template.footer.showPrcLicense = !!$event" />
                <Label for="mc-show-prc" class="font-normal">Show PRC License No.</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-ptr" :model-value="template.footer.showPtrNumber" @update:model-value="template.footer.showPtrNumber = !!$event" />
                <Label for="mc-show-ptr" class="font-normal">Show PTR No.</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-s2" :model-value="template.footer.showS2License" @update:model-value="template.footer.showS2License = !!$event" />
                <Label for="mc-show-s2" class="font-normal">Show S2 License No.</Label>
              </div>
              <div class="flex items-center gap-2">
                <Checkbox id="mc-show-page-number" :model-value="template.footer.showPageNumber" @update:model-value="template.footer.showPageNumber = !!$event" />
        ...
        <div class="flex items-start justify-center rounded-lg border bg-muted/30 p-6">
          ...
          >
            <div class="flex h-full flex-col">
              ...
              <!-- Title -->
              <div class="mb-3 text-center font-bold uppercase" :style="{ fontSize: `${template.fontSize * 0.8}px` }">
                Medical Certificate
              </div>
              ...
              <div class="flex-1 flex flex-col gap-2">
                <div class="flex flex-col gap-1">
                  <div v-if="template.body.showDateOfExamination">
                    <strong>Date of Examination:</strong> March 21, 2026
                  </div>
                </div>

                <div class="mt-1">
                  <span>This is to certify that</span>
                  <span v-if="template.body.showPatientName"> <strong>Juan Dela Cruz</strong></span><span v-if="template.body.showPatientAge">, <strong>32</strong> years old</span><span v-if="template.body.showPatientGender">, <strong>Male</strong></span><span v-if="template.body.showPatientAddress">, residing at <strong>123 Sample St., City</strong></span><span>,</span>
                  <span> was examined and found to be:</span>
                </div>

                <div v-if="template.body.showDiagnosis" class="mt-1">
                  <strong>Diagnosis / Findings:</strong>
                  <div class="mt-0.5 pl-3 italic text-muted-foreground">Upper Respiratory Tract Infection</div>
                </div>

                <div v-if="template.body.showRecommendation" class="mt-1">
                  <strong>Recommendation:</strong>
                  <div class="mt-0.5 pl-3 italic text-muted-foreground">Rest for 3 days. Fit to resume work/school after rest period.</div>
                </div>

                <div v-if="template.body.showDuration" class="mt-1">
                  <strong>Duration:</strong>
                  <span class="text-muted-foreground"> March 21, 2026 — March 23, 2026</span>
                </div>

                <div v-if="template.body.showPurpose" class="mt-1">
                  <strong>Purpose:</strong>
                  <span class="text-muted-foreground"> For school/employment requirement</span>
                </div>
              </div>
              ...
              <!-- Disclaimer -->
              <div v-if="template.body.showDisclaimer" class="mt-3 border-t border-border/50 pt-2 text-muted-foreground text-justify" :style="{ fontSize: `${template.fontSize * 0.35}px`, lineHeight: '1.4' }">
                <strong>Disclaimer:</strong> This medical certificate is issued upon the request of the above-named patient based on clinical findings at the time of examination. It is intended solely for the stated purpose and does not constitute a medico-legal document. This certificate shall not be used as evidence in any court of law or legal proceeding.
              </div>
            </div>
